...
Our approach was to run the simulation of them model for several generations without presence of zombies, and by trial and error find the right rate when the population size is stable or slightly increasing.
